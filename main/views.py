...
from .forms import RegisterUserForm, ChangeUserlnfoForm, SearchForm, BbForm, AIFormSet, \
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if formset.is_valid():
                ...
                messages.add_message(
                    request, messages.ERROR, 'Не корректное заполнение файлов!')
        else:
            messages.add_message(
                request, messages.ERROR, 'Не корректное заполнение формы!')
    else:
